...
BusyLeafsManager::BusyLeafsManager(void)
{
	...
	threadsTime = 0;
	duraction=0;
	cores = new BusyLeafs[CORES];
}

BusyLeafsManager::BusyLeafsManager(int CORES)
{
	this->CORES=CORES;
	threadsTime = 0;
...
void BusyLeafsManager::join_all(){
	group.join_all();
}
...
int BusyLeafsManager::getDuraction(){
	return duraction/1000;
}
